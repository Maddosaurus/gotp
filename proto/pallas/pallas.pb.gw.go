...
func RegisterOtpHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OtpClient) error {
	...
	mux.Handle("GET", pattern_Otp_ListEntries_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/pallas.Otp/ListEntries", runtime.WithHTTPPathPattern("/v1/otp/entries"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Otp_ListEntries_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "otp", "entries"}, ""))
